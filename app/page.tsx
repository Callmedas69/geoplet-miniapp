  ...
  useEffect(() => {
    ...
    const autoGenerate = async () => {
      ...
      try {
        ...
        let friendlyError = "😅 Auto-gen unavailable. Try Regenerate or refresh!";
        ...
        if (errorMessage.toLowerCase().includes("openai") || errorMessage.toLowerCase().includes("service")) {
          if (errorMessage.toLowerCase().includes("credit")) {
            friendlyError = "🔧 Our AI is refueling. Use Regenerate ($3) to skip the wait!";
          } else if (errorMessage.toLowerCase().includes("rate")) {
            friendlyError = "⚡ Engine warming up. Try Regenerate or wait a moment!";
          } else {
            friendlyError = "🎨 Our AI artist is taking a break. Use Regenerate ($3) or refresh!";
          }
        }
