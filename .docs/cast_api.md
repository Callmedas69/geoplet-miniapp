...
pageToken	Optional page token for pagination	pageToken=DAEDAAAGlQ...
reverse	Optional reverse order flag	reverse=true
Note You can use either ?fid=...&hash=... OR ?url=... to query this endpoint
...
pageToken	Optional page token for pagination	pageToken=DAEDAAAGlQ...
reverse	Optional reverse order flag	reverse=true
Note Use the mentionsPositions to extract the offset in the cast text where the FID was mentioned
