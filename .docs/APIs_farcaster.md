...
Concepts
Channels: The Farcaster client has the concept of channels which build upon FIP-2 (setting parentUrl on casts). You can read more about channels in the documentation.
Get All Channels
GET /v2/all-channels
...
name - action name
icon - an Octicon identifying the action
